...
from app.phase_5.session_01 import graph as g, State
...
# {"product_name":"Travel Diary", "description":"An application that lets users log expenses and memories (text, voice, images, videos), split bills within groups, plan itineraries, receive AI-generated daily summaries based on their entries, and get AI suggestions for itinerary planning."}
# 
